...
func (in *CiliumBGPAdditionalRoutes) DeepCopyInto(out *CiliumBGPAdditionalRoutes) {
	*out = *in
	if in.CIDRs != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CiliumBGPAdditionalRoutes.
func (in *CiliumBGPAdditionalRoutes) DeepCopy() *CiliumBGPAdditionalRoutes {
	if in == nil {
		return nil
	}
	out := new(CiliumBGPAdditionalRoutes)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CiliumBGPVirtualRouter) DeepCopyInto(out *CiliumBGPVirtualRouter) {
	*out = *in
	...
	if in.AdditionalRoutes != nil {
		...
		*out = make([]CiliumBGPAdditionalRoutes, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
