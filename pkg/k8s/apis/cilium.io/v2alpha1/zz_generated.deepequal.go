...
func (in *CiliumBGPAdditionalRoutes) DeepEqual(other *CiliumBGPAdditionalRoutes) bool {
	if other == nil {
		return false
	}
...
func (in *CiliumBGPVirtualRouter) DeepEqual(other *CiliumBGPVirtualRouter) bool {
	...
	if ((in.AdditionalRoutes != nil) && (other.AdditionalRoutes != nil)) || ((in.AdditionalRoutes == nil) != (other.AdditionalRoutes == nil)) {
		in, other := &in.AdditionalRoutes, &other.AdditionalRoutes
		if other == nil {
			return false
		}
